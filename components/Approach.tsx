  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We will work together to define your website’s objectives, target audience, and essential functionalities. Our discussion will cover site structure, navigation, and content needs." >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        description="Once we agree on the plan, I cue my lofi playlist and dive into
          coding. From initial concepts to refined code, I ensure you are updated throughout the entire process.">
           <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] max-w-sm w-full mx-auto p-4 lg:h-[35rem] rounde-3xl relative h-[30rem]"
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute top-[40%] left-[50%] translate-x-[-50%] items-center translte-y-[-50%] group-hover/canvas-card:opacity-0 transition duration-200 w-full mx-auto flex justify-center">
          {icon}
        </div>
